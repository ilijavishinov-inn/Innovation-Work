...
#     api_key="Y6REi8ZeCHLyagCgtqOj5XiYL", project_name="glyco lr rf"
# )
...
model_description = f'noTransforms_PCAafterScaling_i{num_iter}'
...
# PYCHARM
path = 'C:\\Users\\ilija\\Pycharm Projects\\GLYCO\\MODELS\\LT&ELT_HRV_GLYCO\\11.08\\'
...
for file_name in file_names:
    ...
    for dataset in datasets:
        ...
        # >>
        workflow_dict['intersect of patients in train and test'] = list(
            set(train['Patient_ID'].unique()).intersection(set(test['Patient_ID'].unique())))
        ...
        for classifier in classifiers:
            ...
            if classifier == "lr":
                ...
                params = [
                    {
                        "pca__n_components": np.linspace(5, 20, num=15, dtype=int),
                ...
                # experiment.set_name(f'{classifier}_{dataset}')
                #
                ...
                # scores_dict = {k: scores_and_samples_dict[k] for k in
                #                ('Accuracy', 'f1_macro', 'f1_1', 'f1_0', 'Precision', 'Recall', 'NPV', 'Specificity')}

                # experiment.log_metrics(scores_dict)
