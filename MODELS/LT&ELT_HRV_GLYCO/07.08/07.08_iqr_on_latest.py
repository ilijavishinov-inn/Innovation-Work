...
model_description = f'scaling_before_pca_IQR_i{num_iter}'
...
# PYCHARM
path = 'C:\\Users\\ilija\\Pycharm Projects\\GLYCO\\MODELS\\LT&ELT_HRV_GLYCO\\07.08\\'
...
def remove_outliers(dataframe,  method, feature_names=None):
...
# Outlier detection
        ...
        outlier_method = 'iqr'
        records_no_outliers = remove_outliers(dataframe = records_positive,
                                                                  method=outlier_method,
                                                                  feature_names = outlier_columns)

        # >>
        workflow_dict["Outliers Method"] = outlier_method
